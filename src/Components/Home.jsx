                    ...
                    <div className="col-md-6 mt-5 pt-3  ">
                        <div className=" mx-auto">
                            <div className='rounded-3 md-img-shadow mx-2' data-aos="fade-right" data-aos-duration="700">
                                <img src={demo2} className='img-fluid' alt="md-img" />
                            </div>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className='mt-5'>
                            <p className='display-3' style={{ fontWeight: "1000" }}> <span className='mt-4 pt-4 heading2 ' >Hi,</span> <span className="heading2">I'm</span>  <span className='heading float-end  mx-3'>Alexandar John </span>
                                <Typed /></p>
                        </div>
                ...
                <div className='row d-flex justify-content-evenly mt-4 pt-4'>
                    <div className='col-md-5 certification mt-3'>
                        <div className='text-center heading5'>
                            ...
                            <h4 style={{ color: "#ff014f" }}>Mr. Alexandar John</h4>
                        ...
                        <div className="col-md-5">
                            <div className="card custom-card p-5" style={{ height: "850px" }} data-aos="zoom-in" data-aos-duration="500">
                                ...
                                <div className="titlehead mb-3 p-2">
                                    <h4 className="titlehead-area p-0 mb-3 heading7 " >Alexandar John J</h4>
